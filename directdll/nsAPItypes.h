...
// 
// *****************  Version 10  *****************
// User: Kkorver      Date: 2/19/04    Time: 11:20a
// Updated in $/Neuroshare/nsNSNLibrary
// Adjusted the packing so it is restored to the default value at the end
// 
// *****************  Version 9  *****************
// User: Awang        Date: 9/25/03    Time: 9:13a
// Updated in $/Neuroshare/nsNEVLibrary
// Copy local FileDesc into the memory-mapped location pFileCatalog[].
// 
// *****************  Version 6  *****************
...
///////////////////////////////////////////////////////////////////////////////////////////////////
	...
	typedef signed__int8	 int8;
	typedef unsigned__int8	 uint8;
	typedef signed__int16	 int16;
	typedef unsigned__int16 uint16;
	typedef signed__int32	 int32;
	typedef unsigned__int32 uint32;
...
/******************************************
 * added SJS 16 Sept 2012 for loadlibrary matlab
 *
*******************************************/
...
#if defined(_MSC_VER)
    #pragma pack(pop)   // go back to the default packing
#endif

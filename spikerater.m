function Data = spikerater(RAW, spikewindows, bgspikewindows, bgtime)
%------------------------------------------------------------------------
% Data = spikerater(RAW, spikewindows, bgspikewindows, bgtime)
%------------------------------------------------------------------------
...
Data.Info = RAW.D.Info;
Data.Stimulus = RAW.Stimulus;
Data.AttenVals = attenVals;
Data.SpikeWindows = spikewindows;

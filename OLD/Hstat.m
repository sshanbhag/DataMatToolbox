function [Hvalue, Hmean, HProb] = hstat(Ddistance, varargin)
%------------------------------------------------------------------------
% [Hvalue, Hmean, HProb] = hstat(Ddistance, RandSets)
%------------------------------------------------------------------------
%
%	Ddistance = confusion matrix
% 	RandSets = # of random sets to generate in bootstrap
% 					(default is 10)
%
% Output Args:
% 	Hvalue		classification information in bits
% 	Hmean			avg. randomized information in bits
% 	HProb			p value for Hvalue re: Hmean
%------------------------------------------------------------------------
...
%Calculates the significance for a confusion matrix
Nset = Ddistance;

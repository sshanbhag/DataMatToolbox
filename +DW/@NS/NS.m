...
classdef (ConstructOnLoad = true) NS 
%------------------------------------------------------------------------
	%------------------------------------------------------------------------
	%------------------------------------------------------------------------
	%------------------------------------------------------------------------
...
% 																				wavList{n}(m) );
		...
		%------------------------------------------------------------------------
		%------------------------------------------------------------------------
		function S = getSegmentStruct(obj, varargin)
		%------------------------------------------------------------------------
		% Segment = NS.getSegmentStruct(segList, wavList)
		%------------------------------------------------------------------------
			...
			S = DW.readSegment(obj.Hfile, obj, 'LoadWaves', 0);
